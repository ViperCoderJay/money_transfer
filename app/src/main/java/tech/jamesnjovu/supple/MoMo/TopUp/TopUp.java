package tech.jamesnjovu.supple.MoMo.TopUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SMobile.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 1:
                        Toast.makeText(TopUp.this, "Airtel Money Top Up", Toast.LENGTH_SHORT).show();
                        break;
                    case 2:
                        Toast.makeText(TopUp.this, "MTN MoMo Top Up", Toast.LENGTH_SHORT).show();
                        break;
                    case 3:
                        Toast.makeText(TopUp.this, "Zamtel Money Top Up", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
